...
void choice() {
  ...
  text("Press '1' for the vaporfly",width/3,400);
  text("Press '2' for the waffle racer",500,400);
  }
...
void game(){
 ...
 // if (mouseX>600){
   // state ="gameover";
  //}
  //Press 1 to change the colorways. 2 to quit
...
void game2(){
  ...
  fill(0);
  text("Press 1 to see the different colorways.",height/2,75);
   text("This is " + bio2[posbio2],height/2,150);
  text("Press 2 to quit",height/2,650);
